 ...
 * @generated
 */
public class PlanValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "org.eclipse.virgo.schema.plan";
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case PlanPackage.NAME_VALUE_TYPE:
				return validateNameValueType((NameValueType)value, diagnostics, context);
			case PlanPackage.PLAN:
				return validatePlan((Plan)value, diagnostics, context);
			case PlanPackage.VERSION_TYPE:
	 ...
	 * @generated
	 */
	public boolean validateNameValueType(NameValueType nameValueType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(nameValueType, diagnostics, context);
	}
	...
	public static final  PatternMatcher [][] VERSION_TYPE__PATTERN__VALUES =
		new PatternMatcher [][] {
			new PatternMatcher [] {
				XMLTypeUtil.createPatternMatcher("\\d+(\\.\\d+(\\.\\d+(\\.([\\w_-])+)?)?)?")
			}
		};
	...
	public boolean validateVersionType_Pattern(String versionType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(PlanPackage.Literals.VERSION_TYPE, versionType, VERSION_TYPE__PATTERN__VALUES, diagnostics, context);
	}
